...
// **************JSON
// JSON.parse(массив) - проходит по JSON и преобразует его из тупо строки в нужный тип данных (объект, массив и т.д.)
// JSON.stringify(массив) - обратная парсу операция по подготовке данных к записи в json
